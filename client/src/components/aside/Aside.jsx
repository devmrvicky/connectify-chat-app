...
const Aside = () => {
  ...
  return (
    <SideBarLayout
      ...
      className="max-[800px]:max-w-[250px] max-[720px]:hidden max-[420px]:block max-[420px]:bg-white dark:max-[420px]:bg-black max-[420px]:absolute z-10 max-[420px]:max-w-[100%] top-0 left-0 "
    >
