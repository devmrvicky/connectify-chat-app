...
const ImgSendWindow = ({ name, size, src, closeWindow, imgFile }) => {
  ...
  return (
    <div className="max-w-[300px] w-full h-auto bg-light-bg2 dark:bg-dark-bg2 text-dark-text2 dark:text-light-text2 flex flex-col gap-2 absolute z-30 p-2 shadow border rounded left-0 bottom-0">
